> **Legacy project** — this folder contains the original 2025-present OLS/Random-Forest work and its datasets (`MA_Statistics_2025-Present__Claude_Code_.xlsx`, `New_Training_Sheet_2.xlsx`). It is kept for reference and is **not** part of the current deal-duration models, which live at the repo root and train on `LARGE_DATASET (TOGGLES).xlsx`. See `../MODELS.md`.
